...
//	vector<vector<int>> data = readCSV("C:\\Users\\infer\\Desktop\\Practice-Software-main\\Practice-Software-main\\VisCanvas2.0\\SimpleMushroomDataReal.csv");
//
...
// Standalone rule generation program
// string manipulate Eli's

//relax requirements for attributes to be the same
#include<stdio.h>
#include <stdlib.h>
#include<vector>
#include<iostream>
...
vector<vector<double>> getArrayFromCSV(string filePath)
{
	//remove rows or ask to cancel. 
	//make note of how many are removed and how many are left

	vector<vector<double>> data;
	//opens the config file
	ifstream precThreshInp;
	precThreshInp.open(filePath);
	vector<vector<float>> precThreshs;
...
int main()
{
	...
	vector<vector<double>> data = readCSV("C:\\Users\\infer\\Desktop\\Practice-Software-main\\Practice-Software-main\\VisCanvas2.0\\SimpleMushroomDataReal.csv");

	//// create vectors which hold the cordinate values
	//// Hard coded //
	//vector<double> x1 = { 0, 1 }; //2
	//vector<double> x2 = { 0, 1, 2, 3 }; // 4
	//vector<double> x3 = { 0, 1, 2 }; // 3
	//vector<double> x4 = { 0, 1, 2 }; // 3

	//// create vectors which hold the id values. Last value is class output
	//// Hard coded //
	////before using, must remove duplicates
	//vector<double> id0  =	{ 0, 0, 0, 0, 1 };
	//vector<double> id1  =	{ 1, 0, 0, 0, 1 };
	//vector<double> id2  =	{ 1, 1, 1, 1, 1 };
	//vector<double> id3  =	{ 1, 2, 1, 1, 1 };
	//vector<double> id4  =	{ 1, 3, 1, 1, 1 };
	//vector<double> id5  =	{ 0, 0, 2, 2, 1 };
	//vector<double> id6  =	{ 0, 0, 1, 2, 1 };
	//vector<double> id7  =	{ 0, 0, 0, 2, 1 };
	//vector<double> id8  =	{ 1, 2, 2, 0, 1 };
	//vector<double> id9  =	{ 0, 2, 2, 0, 1 };
	//vector<double> id10 =	{ 1, 2, 0, 1, 2 };
	//vector<double> id11 =	{ 1, 1, 0, 1, 2 };
	//vector<double> id12 =	{ 1, 0, 0, 1, 2 };
	//vector<double> id13 =	{ 1, 1, 2, 2, 2 };
	//vector<double> id14 =	{ 0, 1, 2, 2, 2 };
	//vector<double> id15 =	{ 0, 2, 2, 0, 2 };
	//vector<double> id16 =	{ 0, 2, 1, 0, 2 };
	//vector<double> id17 =	{ 0, 2, 0, 0, 2 };
	//vector<double> id18 =	{ 1, 1, 2, 1, 2 };
	//vector<double> id19 =	{ 1, 1, 2, 2, 2 };

	//before using, must remove duplicates
	//vector<double> id0 = { 1, 0, 0, 0, 1 };
	//vector<double> id1 = { 2, 0, 0, 0, 1 };
	//vector<double> id2 = { 1, 0, 0, 0, 1 };
	//vector<double> id3 = { 2, 0, 0, 0, 1 };
	//vector<double> id4 = { 1, 0, 0, 0, 1 };
	//vector<double> id5 = { 0, 0, 0, 0, 1 };
	//vector<double> id6 = { 0, 0, 0, 0, 1 };
	//vector<double> id7 = { 0, 0, 0, 0, 1 };
	//vector<double> id8 = { 0, 0, 0, 0, 1 };
	//vector<double> id9 = { 0, 0, 0, 0, 1 };
	//vector<double> id10 = { 3, 0, 0, 0, 2 };
	//vector<double> id11 = { 3, 0, 0, 0, 2 };
	//vector<double> id12 = { 3, 0, 0, 0, 2 };
	//vector<double> id13 = { 3, 0, 0, 0, 2 };
	//vector<double> id14 = { 3, 0, 0, 0, 2 };
	//vector<double> id15 = { 3, 0, 0, 0, 2 };
	//vector<double> id16 = { 3, 0, 0, 0, 2 };
	//vector<double> id17 = { 3, 0, 0, 0, 2 };
	//vector<double> id18 = { 3, 0, 0, 0, 2 };
	//vector<double> id19 = { 3, 0, 0, 0, 2 };

	////no duplicates allowed
	////vector<double> id0  =	{ 4, 0, 0, 0, 1 };
	////vector<double> id1  =	{ 5, 0, 0, 0, 1 };
	////vector<double> id2  =	{ 3, 0, 0, 0, 1 };
	////vector<double> id3  =	{ 6, 0, 0, 0, 1 };
	////vector<double> id4  =	{ 9, 0, 0, 0, 1 };
	////vector<double> id5  =	{ 1, 0, 0, 0, 1 };
	////vector<double> id6  =	{ 2, 0, 0, 0, 1 };
	////vector<double> id7  =	{ 7, 0, 0, 0, 1 };
	////vector<double> id8  =	{ 0, 0, 0, 0, 1 };
	////vector<double> id9  =	{ 8, 0, 0, 0, 1 };
	////vector<double> id10 =	{ 10, 0, 0, 1, 2 };
	////vector<double> id11 =	{ 11, 1, 0, 1, 2 };
	////vector<double> id12 =	{ 12, 0, 0, 1, 2 };
	////vector<double> id13 =	{ 13, 1, 2, 2, 2 };
	////vector<double> id14 =	{ 14, 1, 2, 2, 2 };
	////vector<double> id15 =	{ 13, 2, 2, 0, 2 };
	////vector<double> id16 =  { 14, 2, 1, 0, 2 };
	////vector<double> id17 =  { 14, 2, 0, 0, 2 };
	////vector<double> id18 =  { 13, 1, 2, 1, 2 };
	////vector<double> id19 =  { 13, 2, 2, 2, 2 };
	...
	//vector<double> id8 = { 0, 0, 0, 0, 1 };
	//vector<double> id9 = { 8, 0, 0, 0, 1 };
	//vector<double> id10 = { 10, 0, 0, 0, 2 };
	//vector<double> id11 = { 11, 0, 0, 0, 2 };
	//vector<double> id12 = { 12, 0, 0, 0, 2 };
	//vector<double> id13 = { 13, 0, 0, 0, 2 };
	//vector<double> id14 = { 14, 0, 0, 0, 2 };
	//vector<double> id15 = { 15, 0, 0, 0, 2 };
	//vector<double> id16 = { 16, 0, 0, 0, 2 };
	//vector<double> id17 = { 100, 0, 0, 0, 2 };
	//vector<double> id18 = { 101, 0, 0, 0, 2 };
	//vector<double> id19 = { 102, 0, 0, 0, 2 };
	...
	// find the minimum and maximum for each coordinate/attribute
	// not currently needed*/
	//vector<double> coordinateMax;
	//vector<double> coordinateMin;
	...
	for (int compXIndex = 0; compXIndex < data.size(); compXIndex++)
	{
		...
		// comparison case to keep track of current case to be compared
		vector<double> comparisonCase = data.at(compXIndex);

		for (int dataXIndex = 0; dataXIndex < data.size(); dataXIndex++)
		{
			for (int dataYIndex = 0; dataYIndex < (data.at(dataXIndex).size() - 1); dataYIndex++)//-1 to account for the class
			{
				// check that the comparisonX and the dataX are not the same (in otherwords, that rows are not the same)
				if (compXIndex != dataXIndex)
				{
					// subtract the comparison data from the data being compared
					difference.push_back(((comparisonCase.at(dataYIndex)) - (data.at(dataXIndex).at(dataYIndex))));
					//int difference = ((comparisonCase.at(dataYIndex)) - (data.at(dataXIndex).at(dataYIndex)));
					//if (abs(difference) == 1 && data.at(compXIndex).at(data.at(compXIndex).size() - 1) == data.at(dataXIndex).at(data.at(dataXIndex).size() - 1))
					//{
					//	//cout << "Match " << dataXIndex << " pushed to vector" << endl;
					//	matches.push_back(dataXIndex);
					//}
		...
		*/
		...
		for (int match = 0; match < matches.size(); match++)
		{
			...
			// temporary vector to hold this comparisons expandable flags
			vector<double> tempExpansionDirection;

			// temporary vector to hold this comparisons expandable IDs
			vector<double> tempId;

			// temporary vector to hold the index of the expansion
			vector<double> tempColumnInd;
